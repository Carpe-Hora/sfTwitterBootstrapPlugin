...
class sfTwitterBootstrap
{
   ...
   * @return array
   *
   * @see sfTwitterBootstrap::initItem()  All items are initialized before being returned through this method
   * @see sfTwitterBootstrap::getProperty()
   */
   ...
   * @return array
   *
   * @see sfTwitterBootstrap::getItems()
   * @see sfTwitterBootstrap::getCategories()
   * @see sfTwitterBootstrap::getProperty()
   */
   ...
   *
   * @see sfTwitterBootstrap::initItem()
   * @see sfTwitterBootstrap::getProperty()
   */
