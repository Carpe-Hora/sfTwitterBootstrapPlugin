...
<?php unset($this->config['list']['table_count_method']) ?>
  ...
  {
    return <?php echo $this->asPhp(isset($this->config['list']['partial']) ? $this->config['list']['partial'] : array()) ?>;
<?php unset($this->config['list']['partial']) ?>
  ...
  {
    return <?php echo $this->asPhp(isset($this->config['edit']['partial']) ? $this->config['edit']['partial'] : array()) ?>;
<?php unset($this->config['edit']['partial']) ?>
  ...
  {
    return <?php echo $this->asPhp(isset($this->config['new']['partial']) ? $this->config['new']['partial'] : array()) ?>;
<?php unset($this->config['new']['partial']) ?>
  ...
  {
    return <?php echo $this->asPhp(isset($this->config['show']['partial']) ? $this->config['show']['partial'] : array()) ?>;
